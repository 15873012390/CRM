...
public class QiniuUtils {
    //获取方式也自行百度吧
    private String accessKey = "Gsfi_Z9Kz5mkfafSx1qAiSm-i35i8AIY6Hy7npLd";//上传凭证AccessKey
    private String secretKey = "EH0Bog_jJ7vImxfsJMduM0fywfdXS8yTsr3VOW0f";//上传凭证secretKey
    private String bucketName = "productupload1";//存储空间名称
    private String fileDomain = "http://q9ho64dhd.bkt.clouddn.com/";//使用的域名 需要改成自己的哦
